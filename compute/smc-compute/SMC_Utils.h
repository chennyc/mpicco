...
public:
	...
	void smc_open_batch(mpz_t* var, int* result, int size, int threadID);
	float smc_open(mpz_t* var, int threadID); 

	void smc_communication_summary();

	//Malicious functions
	void smc_init_mal();
	void smc_clean_mal();
	void smc_input_mal(int id, mpz_t* var, int size, int varlen, std::string type, int threadID);
	void smc_input_Onlymul(mpz_t** a, int input_num, int size, int alen, std::string type, int threadID);
	...
	void smc_leq_mal(mpz_t** a, mpz_t** b, int alen, int blen, mpz_t** result, int resultlen, int size, std::string type, int threadID); 
	void smc_leq_mal(mpz_t* a, mpz_t* b, mpz_t* result, int alen, int blen, int resultlen, std::string type, int threadID);
	...
	void smc_bitcomp_mal(mpz_t*** a, mpz_t*** b, mpz_t** s, int size, int batch_size, int threadID);
	...
	void smc_bitcomp(mpz_t** a, mpz_t** b, mpz_t* s, int size, int batch_size, int threadID);
